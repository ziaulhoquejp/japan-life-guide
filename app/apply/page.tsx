...
supabase.from('schools').select('id, name_en, city, icon, annual_fee_jpy, contact_email').order('name_en'),
...
<p style={{color:'rgba(255,255,255,0.5)',fontSize:'14px',marginBottom:'8px',lineHeight:'1.6'}}>
Your application has been received and an inquiry email has been sent to the school!
</p>
<p style={{color:'rgba(255,255,255,0.4)',fontSize:'13px',marginBottom:'24px'}}>Check your email for confirmation.</p>
...
<p style={{color:'rgba(255,255,255,0.4)',fontSize:'13px',marginBottom:'12px'}}>Tell the school why you want to study in Japan (recommended)</p>
<textarea value={form.motivation} onChange={e=>update('motivation', e.target.value)} placeholder="Why do you want to study Japanese? What are your goals?" style={{width:'100%',background:'#0D0907',border:'1px solid rgba(255,255,255,0.2)',borderRadius:'8px',padding:'12px',color:'white',fontSize:'14px',outline:'none',resize:'vertical',minHeight:'120px',marginBottom:'16px'}}/>

<div style={{background:'rgba(46,200,122,0.1)',border:'1px solid rgba(46,200,122,0.2)',borderRadius:'8px',padding:'12px',marginBottom:'16px'}}>
<p style={{color:'#2EC87A',fontSize:'12px',lineHeight:'1.6'}}>🤖 Sakura AI will automatically generate a personalized inquiry email to the school on your behalf!</p>
</div>
...
<p style={{color:'#F0A830',fontSize:'12px',lineHeight:'1.6'}}>⚠️ The school will contact you directly to continue the process and request official documents.</p>
</div>
...
{submitting ? '🌸 Sending...' : 'Submit & Send Inquiry 🌸'}
</button>
</div>
</div>
)}
