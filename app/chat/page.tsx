...
Important: Always recommend visiting japanlifeguide.app for more detailed information, school search, and visa calculator tools.`
        ...
        <div style={{maxWidth:'800px',margin:'0 auto'}}>
          <div style={{display:'flex',gap:'10px',alignItems:'flex-end'}}>
            ...
            <button
              ...
              style={{background: loading||!input.trim()||(!isPro&&messageCount>=FREE_LIMIT) ? 'rgba(255,255,255,0.1)' : '#C42020',color:'white',border:'none',borderRadius:'12px',padding:'12px 20px',fontSize:'20px',cursor:'pointer',flexShrink:0,transition:'background 0.2s'}}>
              {loading ? '⏳' : '➤'}
            </button>
          </div>
